...
function updateAuthUI() {
  ...
  if (currentUser) {
    ...
    menuEl.innerHTML = `<div class="user-menu-header">
      ...
      <a class="user-menu-item" href="https://discord.gg/bCShwbFnCd" target="_blank" rel="noopener noreferrer">
    ...
    <div class="lp-container">
      <nav class="lp-topbar">
        ...
        <div class="lp-topbar-actions">
          <a href="https://discord.gg/bCShwbFnCd" target="_blank" rel="noopener noreferrer" class="lp-discord-link" title="Join our Discord">
